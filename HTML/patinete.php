<!-- filepath: c:\xampp\htdocs\PaginaWebHTMLyCSSCargaPHP\HTML\patinete.php -->
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
<body>
    <header class="header">
        <div class="container">
            ...
            <nav class="menu">
                <input type="text" placeholder="Buscar patinetes, deportes, espectáculos o parques temáticos" />
    ...
    <main>
        <!-- Contenido dinámico cargado desde transformar_patinetes.php -->
        <div class="dynamic-content">
            <?php include('../XML-XSD/transformar_patinetes.php'); ?>
        </div>
    </main>
    ...
    <footer class="footer">
        <div class="footer-container">
            <div class="footer-section">
                ...
                <p>PassNow es tu mejor opción para acceder a patinetes eléctricos, deportes, espectáculos y más.</p>
            </div>
            <div class="footer-section">
                ...
                <a href="parquesTematicos.html">Parques Temáticos</a>
            </div>
            <div class="footer-section">
                <h3>Contacto</h3>
