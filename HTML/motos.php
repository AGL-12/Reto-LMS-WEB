...
<body>
    ...
    <div class="cover-container">
        <img src="../imagenes/encabezadoMotos.jpg" alt="Portada" class="cover-image">
    </div>

    <!-- Contenido dinámico cargado desde transformar_motos.php -->
    <main>
        <div class="dynamic-content">
            <?php include('../XML-XSD/transformar_motos.php'); ?>
        </div>
    </main>
